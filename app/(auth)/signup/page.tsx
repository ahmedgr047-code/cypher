...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      />
      <motion.div
        className="absolute bottom-1/3 left-1/4 w-64 h-64 bg-primary/10 rounded-full blur-3xl"
        animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.5, 0.3, 0.5],
        }}
      ...
      >
        <div className="glass neon-glow-subtle rounded-2xl p-8 space-y-8">
          {/* Logo */}
          <div className="flex flex-col items-center space-y-2">
            <CypherLogo size="lg" />
            <h1 className="text-2xl font-bold text-foreground">Create Account</h1>
            <p className="text-muted-foreground text-sm">Join Cypher and unlock AI power</p>
          </div>
