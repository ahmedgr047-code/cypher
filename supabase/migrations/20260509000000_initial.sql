...
values
  ('اشرح لي مفهوم التفاضل والتكامل', 10),
  ('لخص لي قوانين نيوتن', 20),
  ('ما هي أساسيات البرمجة الكائنية؟', 30),
  ('اشرح الكيمياء العضوية للمبتدئين', 40),
  ('ما هي قواعد البيانات العلائقية؟', 50),
  ('اشرح الدوال الرياضية بأمثلة', 60)
