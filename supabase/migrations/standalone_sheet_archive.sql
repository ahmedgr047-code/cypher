-- ═══════════════════════════════════════════════════════════════════════════
-- للصق يدوياً في Supabase → SQL Editor (جدول أرشيف الشيتات فقط، بدون تلغرام)
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ترحيل من الجدول القديم فقط إن وُجد عمود storage_object_path (رفعات الويب).
-- إن لم يُضف هذا العمود في مشروعك قديماً، يُتخطّى الترحيل — لا خطأ.
do $$
begin
  if exists (
